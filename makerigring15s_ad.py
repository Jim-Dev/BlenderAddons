###################################
# Make Rigidbody Ring (addon-short)
#       v.1.5s (addon short ver.)
#  (c)Ishidourou 2013
###################################
...
bl_info = {
    "name": "Make Rig Ring 15s",
    "author": "ishidourou",
    "version": (1, 5),
    "blender": (2, 65, 0),
    "location": "View3D > Add > Mesh > New Object",
    "description": "Make Rigidbody Ring short version",
    "warning": "",
    "wiki_url": "",
    "tracker_url": "",
    "category": "Add Mesh"}
...
class MakeRigRings(bpy.types.Operator):

    bl_idname = "object.makerigrings"
...
#bpy.utils.register_class(MakeRigRings)

# Registration

def add_object_button(self, context):
    self.layout.operator(
        MakeRigRings.bl_idname,
        text="Rigidbody Ring_s",
        icon='PLUGIN')
...
def unregister():
    bpy.utils.unregister_class(MakeRigRings)
